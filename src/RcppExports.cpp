...
// pqsfinder
SEXP pqsfinder(SEXP subject, int max_len, int min_score, int run_min_len, int run_max_len, int loop_min_len, int loop_max_len, int max_bulges, int max_mismatches, int max_defects, int tetrad_bonus, int bulge_penalty, int mismatch_penalty, float loop_mean_factor, float loop_sd_factor, std::string run_re, SEXP custom_scoring_fn, bool use_default_scoring, bool verbose);
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(pqsfinder(subject, max_len, min_score, run_min_len, run_max_len, loop_min_len, loop_max_len, max_bulges, max_mismatches, max_defects, tetrad_bonus, bulge_penalty, mismatch_penalty, loop_mean_factor, loop_sd_factor, run_re, custom_scoring_fn, use_default_scoring, verbose));
    return __result;
END_RCPP
}
